...
```
## (Sajnos nem működik valamiért, hibát jelez. 
## Már nem volt időm megnézni, hogy mi a baj.)
...
# rendbe beolvassa
# így működött élesben csak: 
tweets <- read.csv2(file = "data/clinton_trump_tweets.csv")
head(tweets)
# de így kellene pontosan megadni:
# tweets <- read.csv2(file = "data/clinton_trump_tweets.csv", header = T, sep = ";", quote = "\"",
                        # fill=T, comment.char = "", fileEncoding = "UTF-8")
# head(tweets)
...
### IV. feladat/ 1. - Oszlopdiagrammos összehasonlítás:
```{r, echo = TRUE}
